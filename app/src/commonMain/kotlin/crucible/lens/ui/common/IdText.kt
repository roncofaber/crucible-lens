 ...
 * Purely visual: callers attach their own click/copy behaviour (or none) via [modifier] - some IDs
 * are tap-to-copy themselves, some sit next to a separate copy button, some are inert and reachable
